...
Route::prefix('admin')->middleware(['web', 'auth'])->group(function () {
    ...
    Route::get('/settings', [App\Http\Controllers\AdminController::class, 'getSettings'])->name('admin.settings')->middleware(\App\Http\Middleware\EnsureRole::class . ':admin');
    Route::post('/settings/update', [App\Http\Controllers\AdminController::class, 'updateSettings'])->name('admin.settings.update')->middleware(\App\Http\Middleware\EnsureRole::class . ':admin');
    

    Route::get('/reports', [App\Http\Controllers\ReportsController::class, 'viewReport'])->name('admin.report')->middleware(\App\Http\Middleware\EnsureRole::class . ':trabajador|admin');
    Route::post('/reports/generate', [App\Http\Controllers\ReportsController::class, 'fetchSalesData'])->name('admin.report.generate')->middleware(\App\Http\Middleware\EnsureRole::class . ':trabajador|admin');

    Route::get('/pedidos-history', [App\Http\Controllers\AdminPedidosController::class, 'history'])->name('admin-pedidos.history')->middleware(\App\Http\Middleware\EnsureRole::class . ':trabajador|admin');
